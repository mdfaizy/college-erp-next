...
// ✅ CREATE ROLE
export const createRole = async (data: { name: string }) => {
  return await apiConnector("POST", "/roles", data);
};

// ✅ GET ROLES
export const getRoles = async () => {
  return await apiConnector("GET", "/roles");
};

// ✅ GET PERMISSIONS
export const getPermissions = async () => {
  return await apiConnector("GET", "/permissions");
};
...
export const updateRole = async (
  ...
  return await apiConnector("PUT", `/roles/${id}`, data);
};

export const getRoleById = async (id: number) => {
  return await apiConnector("GET", `/roles/${id}`);
};