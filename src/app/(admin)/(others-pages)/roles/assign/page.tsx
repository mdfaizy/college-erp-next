...
// import { getRoles, assignPermissions } from "@/services/roleService";
...
//         .filter((p) => assigned.includes(p.key))
//         .map((p) => p.id);
...
//       <h1 className="text-xl font-bold mb-4">Assign Permissions</h1>
